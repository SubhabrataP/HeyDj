...
export default class Login extends Component {
  ...
  isFormValid = () => {
    ...
    Object.values(formErrors).forEach((val) => {
      val.length > 0 ? (isValid = false) : (isValid = true);
    });
  ...
  onGoogleLogin = () => {
    window.open(
      "https://xug5l9nwo4.execute-api.ap-south-1.amazonaws.com/dev/api/auth/google",
      "_self"
    );
  };
  ...
  onFacebookLogin = () => {
    window.open(
      "https://xug5l9nwo4.execute-api.ap-south-1.amazonaws.com/dev/api/auth/facebook",
      "_self"
    );
  };
        ...
        <Modal show={this.state.showModal}>
          <div className="container loginBg" style={{ color: "#fff" }}>
            ...
            >
              ...
              >
                {this.state.sendOTPClicked ? "Resend OTP" : "Send OTP"}
              </button>
            </div>
            <div className="row">
              <Label
            ...
            >
              <div className="col-md-12 mb-3">
                <span style={{ paddingTop: "3%", paddingRight: "2%" }}>
                  Login With:
                </span>
