          ...
          if (res.data.spotify) {
            if (
              ...
              if (res.data.spotify.includes("https://open.spotify.com/")) {
                res.data.spotify = res.data.spotify.replace(
  ...
  onAddUrl = (type) => {
    ...
    if (type === "video") {
      if (this.state.videoUrl.trim().length < 1) {
        ...
        if(!portfolioData.videoUrls) portfolioData.videoUrls = [];
         portfolioData.videoUrls.push(this.state.videoUrl);
        this.setState({
          videoUrlError: "",
          videoUrl: "",
          portfolioData
          ...
          <div className="col-sm-8 ml-2 dj-play-list p-3">
            ...
            <div className="row col-sm-12" style={{ marginBottom: "2%" }}>
              ...
              <TextField
                ...
                onChange={(ev, videoUrl) =>
                  this.setState({ videoUrl, videoUrlError: "" })
                }
            ...
            <div className="row" style={{ marginBottom: "5%" }}>
              {Object.entries(this.state.portfolioData).length !== 0 &&
                this.state.portfolioData.videoUrls &&
                this.state.portfolioData.videoUrls.map((data) => (
                  <div className="col-sm-4" style={{ marginBottom: "5%" }}>
                    ...
                    <button
                      type="button"
                      className="customBtnWhite mx-auto mt-2 d-block"
                      onClick={() => {
                        this.onRemoveUrl("video", data);
                      }}
                    >
                      Remove
                    </button>
            ...
            <div className="row mt-4">
              ...
              <div className="col-sm-12">
                {Object.entries(this.state.portfolioData).length !== 0 ? (
                  this.state.portfolioData.spotify === undefined ||
                  this.state.portfolioData.spotify === "" ? (
                    <div
                    ...
                    >
                      ...
                      <TextField
                        ...
                        onChange={(ev, spotifyUrl) =>
                          this.setState({ spotifyUrl, spotifyUrlError: "" })
                        }
                    ...
                    <div className="row" style={{ marginBottom: "2%" }}>
                      <div className="col-sm-12" style={{ marginBottom: "2%" }}>
                        <iframe
                          src={this.state.portfolioData.spotify}
                          width="100%"
                          height="220"
                          frameBorder="0"
