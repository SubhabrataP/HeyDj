        ...
        <Layout history={this.props.history}>
          <div className="container" style={{ marginTop: "1%" }}>
            <div className="row" style={{ marginBottom: "1%" }}>
              <h5 className={"col-md-3"}>DJ Details List</h5>
              <div className={"row col-md-9"} style={{ textAlign: "right" }}>
                <input
                  type="search"
                ...
                <button
                  className="customBtn"
                  style={{ marginLeft: "2%" }}
                  onClick={() => this.showDjModal("playlist")}
                >
                  Add Playlist
                </button>
                <button
                  className="customBtn"
                  style={{ marginLeft: "2%" }}
                  onClick={() => this.showDjModal("content")}
                >
                  Add Content
                </button>
                <button
                  className="customBtn bg-light text-dark"
                  style={{ marginLeft: "2%" }}
                  onClick={() => this.props.history.push("/Admin/Accounts")}
                >
                  View Stats
                </button>
              </div>
